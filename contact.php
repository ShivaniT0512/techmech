      ...
      <div class="reveal">
        <div class="contact-cards">
          <div class="contact-card">
            ...
            <h4>Call Us</h4>
            <p><a href="tel:+919512696191">+91 95126 96191</a><br><a href="tel:+918460640743">+91 84606 40743</a></p>
          </div>
          <div class="contact-card">
            <i class="fas fa-envelope"></i>
            <h4>Email Us</h4>
            <p><a href="mailto:techmechengineering1@gmail.com">techmechengineering1@gmail.com</a></p>
          </div>
          <div class="contact-card">
            <i class="fas fa-map-marker-alt"></i>
            <h4>Office Address</h4>
            <p>Plot No. 584/Pakki 1, Gala No. 3, Near Canal, 4th Phase GIDC, Vapi, Gujarat</p>
          </div>
          <div class="contact-card">
            <i class="fas fa-building"></i>
            <h4>Registered Address</h4>
            <p>A-201 Mangalam Heights, Near Lakeview Residency, Dungra, Vapi, Gujarat</p>
          </div>
        </div>
