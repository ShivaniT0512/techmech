  ...
  <div class="container">
    ...
    <div class="mv-cards">
      <div class="mv-card reveal">
        ...
        <p>To provide innovative, efficient and customized material handling solutions that help industries streamline operations and maximize productivity.</p>
      </div>
      <div class="mv-card reveal">
        <h3><i class="fas fa-eye"></i> Our Vision</h3>
        <p>To become a leading and trusted brand in material handling engineering through technical excellence, innovation and customer-centric solutions.</p>
      </div>
    </div>
